...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "transcript": {
        ...
        "api_key": "",
        # When true (default), segment-level timestamps are requested via
        # ``verbose_json`` and the JSON output is written as
        # ``[{"start": ..., "end": ..., "text": ...}]`` instead of the raw
        # API payload. Set to false for plain JSON without timestamps.
        "timestamps": True,
